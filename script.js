...
// Putting text on the div

function textCall(joke) {
...
function tellMe(joke) {
    ...
    function test() {
    VoiceRSS.speech({
        key: '6f2222e31eab41669937f5c8dff1ed55',
        src: joke,
        hl: 'en-us',
        r: 0,
        c: 'mp3',
...
async function getJokes () {
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=religious,political,racist&type=twopart';
    try {
